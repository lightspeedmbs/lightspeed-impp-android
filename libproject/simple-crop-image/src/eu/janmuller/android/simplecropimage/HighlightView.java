...
class HighlightView {
	...
	private int mBorderColor = 0xffffff00;
	
	public HighlightView(View ctx,int bordrColor) {
		mContext = ctx;
		mBorderColor = bordrColor;
	}
	...
	private void init() {
		...
		mResizeDrawableHeight = resources
				.getDrawable(R.drawable.camera_crop_length);
...
//					int heightWidth = mResizeDrawableHeight.getIntrinsicWidth() / 2;
					int widthWidth = px2Dp(mContext.getContext(), 44) / 2;
					int widthHeight = px2Dp(mContext.getContext(), 44) / 2;
					
					int heightHeight = px2Dp(mContext.getContext(), 44) / 2;
					int heightWidth = px2Dp(mContext.getContext(), 44) / 2;
