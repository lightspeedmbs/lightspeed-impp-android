...
public class PostListAdapter extends BaseAdapter {
    ...
    public PostListAdapter(Context ct, RoomManager wallMngr) {
        this.ct = ct;
        this.roomManager = wallMngr;
        postList = new ArrayList<Post>();
    }
    ...
    public class PostListItem extends RelativeLayout {
        ...
        public void setData(final int index) {
            ...
            ImageLoader.getInstance(ct).DisplayImage(data.owner.userPhotoUrl, imgUserIcon, R.drawable.friend_default,
                    true);
            ...
            btnLike.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mWallManager != null) {
                        mWallManager.triggerLikeButton(UserManager.getInstance(ct).getCurrentUser(), data,
                                new LikeCallback() {
                                    @Override
                    ...
                    for (int i = 0; i < photoUrls.length; i++) {
                        ...
                        imgPhoto.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                ((Activity) getContext()).overridePendingTransition(R.anim.push_up_in,
