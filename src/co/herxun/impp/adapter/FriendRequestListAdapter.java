...
public class FriendRequestListAdapter extends BaseAdapter {
    ...
    public class FriendRequestListItem extends UserListItem {
        ...
        public FriendRequestListItem(Context ct) {
            ...
            btnApprove.addView(imgApprove, new FrameLayout.LayoutParams(Utils.px2Dp(ct, 24), Utils.px2Dp(ct, 24),
                    Gravity.CENTER));
            ...
            btnReject.addView(imgReject, new FrameLayout.LayoutParams(Utils.px2Dp(ct, 24), Utils.px2Dp(ct, 24),
                    Gravity.CENTER));
